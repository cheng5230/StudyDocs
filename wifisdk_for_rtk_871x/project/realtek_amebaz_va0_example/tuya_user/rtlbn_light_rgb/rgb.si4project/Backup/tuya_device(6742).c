...
STATIC VOID __userIrCmdDeal (IRCMD cmd, IRCODE irType)
{
  ...
  if(light_IrCrtl.IR_Mode)
  {
    ...
    {
       if((last_cmd==KEY_B_LEVEL_4)||(last_cmd==KEY_G_LEVEL_4)||(last_cmd==KEY_W_LEVEL_5)||(last_cmd==KEY_MODE_STROBE)||(last_cmd==KEY_B_LEVEL_3)||(last_cmd==KEY_B_LEVEL_5)||(last_cmd==KEY_MODE_FLASH))
       {
          /**自动模式下，模式加减无效果**/
