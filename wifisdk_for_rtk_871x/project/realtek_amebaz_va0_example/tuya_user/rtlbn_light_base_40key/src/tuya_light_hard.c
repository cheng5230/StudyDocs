...
#endif
STATIC VOID __change_pwm_if_needed (USHORT_T* R_value, USHORT_T* G_value, USHORT_T* B_value, USHORT_T* CW_value,USHORT_T* WW_value)
{
...
VOID __light_pwm_set_duty (UINT_T duty, UCHAR_T channel)
{
  ...
  //PR_DEBUG("pwm  %d %d %d", duty,channel,pwm_status[channel]);
  if (duty == 0)
  {
...
STATIC VOID tuya_light_pwm_output (USHORT_T R_value, USHORT_T G_value, USHORT_T B_value, USHORT_T CW_value,USHORT_T WW_value)
{
  ...
  switch (hw_table->light_mode)
  {
    ...
    case LIGHT_MODE_RGB:
      ...
      //tuya_light_gamma_adjust (USHORT red, USHORT green, USHORT blue, USHORT* adjust_red, USHORT* adjust_green, USHORT* adjust_blue);
