...
void ws2812_timer_handler(uint8_t type,uint8_t times,uint8_t scene_num);
...
#define STREMBER_MODES     1
#define BREATH_MODES       4
#define FIRE_MODES         4
#define COLORFUL_MODES     4
#define PAOMA_MODES        14
#define FLASH_MODES        13
#define SCAN_MODES         3
#define TRIP_MODES         3 
