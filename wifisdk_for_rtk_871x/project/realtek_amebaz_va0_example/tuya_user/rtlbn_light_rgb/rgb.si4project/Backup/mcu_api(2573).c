        ...
        if(mcu_VoiceTemp!=deltavoice)
        {
           ...
           if(__voice_cnt<3)
           {
              ...
              if(__voice_cnt==3)
              {
                 ...
                 /****** 音量大小10个等级 **********/
                 mcu_VoiceTicks = ((mcu_VoiceSPK/20)>9)?9:mcu_VoiceTicks;
                 mcu_VoiceSpeed = VoiceSpeed[mcu_VoiceTicks];
                 PR_NOTICE("1111111111111111-- %d %d",mcu_VoiceSPK,mcu_VoiceTicks);
              }
           }
        }
        else
             ...
             if((mcu_times%200)==0) 
             {
                if(mcu_VoiceSPK)
                {
                    ...
                    if(__voice_cnt==3)
                    {
                       ...
                       mcu_VoiceTicks = ((mcu_VoiceSPK/20)>9)?9:mcu_VoiceTicks;
                       mcu_VoiceSpeed = VoiceSpeed[mcu_VoiceTicks];
                       PR_NOTICE("00000000000--- %d %d",mcu_VoiceSPK,mcu_VoiceTicks);
                    }
                }
             }
          }
