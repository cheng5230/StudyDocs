...
APP_BIN_NAME ?= sample
USER_SW_VER ?= 9.9.9
TY_OUTPUT = ../tuya_user/$(PROJ_SRC_PATH)/output/$(APP_BIN_NAME)_$(USER_SW_VER)
TY_SRC_DIRS += $(shell find ../tuya_common/src -type d)
TY_SRC_DIRS += $(shell find ../tuya_user/$(PROJ_SRC_PATH)/src -type d)
...
TY_INC_DIRS += $(shell find ../tuya_user/$(PROJ_SRC_PATH)/include -type d)
