...
extern uint8_t light_IrCrtl_IR_Mode;
extern uint16_t light_IrCrtl_IR_Runtimes;
extern uint8_t light_IrCrtl_IR_Cnts;
extern uint8_t light_IrCrtl_IR_Cnts;
extern uint8_t light_IrCrtl_IR_Flag;
extern uint8_t light_IrCrtl_Speedtimes;
extern uint8_t light_IrCrtl_ManulTimes;
extern uint8_t light_IrCrtl_ManulFlag;
