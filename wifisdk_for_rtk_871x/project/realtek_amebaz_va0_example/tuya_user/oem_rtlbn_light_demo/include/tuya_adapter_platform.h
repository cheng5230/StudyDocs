...
#define PWM_4_OUT_IO_NUM PA_0  //3channel--WW
#define PWM_5_OUT_IO_NUM PA_22
...
#define LOWPOWER_MODE_DELAY_TIME 2000       //ms
    ...
    /******************************************************************************
 * FunctionName : tuya_light_device_inits
 * Description  : 灯的硬件的启动
 * Parameters   : none
 * Returns      : none
*******************************************************************************/
    ...
    OPERATE_RET tuya_light_CreateAndStart(OUT TUYA_THREAD *pThrdHandle, IN P_THRD_FUNC pThrdFunc, IN PVOID pThrdFuncArg, IN USHORT_T stack_size, IN TRD_PRI pri, IN UCHAR_T *thrd_name);
    ...
    OPERATE_RET tuya_light_button_reg(IN UINT_T gpio_no, IN BOOL_T is_high, IN UINT_T long_key_time, IN KEY_CALLBACK callback);
