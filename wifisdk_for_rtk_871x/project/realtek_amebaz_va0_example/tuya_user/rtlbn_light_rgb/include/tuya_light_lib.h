...
#define IRAUTO_MODEMAXS    3
#define IRAUTO_RUNTIMES    10000
#define MUSIC_RUNTIMES     30000
...
extern uint32_t voiceColor[VOICENUMS];
...
extern unsigned int  dpMusicCnts;
extern unsigned char dpMusicType;
extern unsigned char  dpMusicticks;
extern unsigned int  dpMusictimes;
extern UCHAR_T key_trig_num;
extern DP_DATA_S dp_data;
