#line 1 "C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c"
...
#line 19 "C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c"
#line 1 "C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.h"
...
#line 30 "C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.h"
...
#line 20 "C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c"
...
void gtimer_init (gtimer_t *obj, uint32_t tid)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 61));
...
void gtimer_deinit (gtimer_t *obj)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 84));
...
uint32_t gtimer_read_tick (gtimer_t *obj)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 98));
...
uint64_t gtimer_read_us (gtimer_t *obj)  
{
	(((obj->timer_id < GTIMER_MAX) && (obj->timer_id > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 110));
...
void gtimer_reload (gtimer_t *obj, uint32_t duration_us)
{
	uint32_t tid = obj->timer_id;
        uint32_t temp;
	if(tid<TIMER4)
	 temp = (uint32_t)((float)duration_us  / 1000000 *32768);  
    else
	 temp = 1;
	 do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "id=%d,tmp=%d\n",tid,temp);}while(0);  
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 133));
...
{
	uint32_t tid = obj->timer_id;
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 146));
...
void gtimer_start_one_shout (gtimer_t *obj, uint32_t duration_us, void* handler, uint32_t hid)
{
	(((obj->timer_id < GTIMER_MAX) && (obj->timer_id > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 162));
...
void gtimer_start_periodical (gtimer_t *obj, uint32_t duration_us, void* handler, uint32_t hid)
{
	(((obj->timer_id < GTIMER_MAX) && (obj->timer_id > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 183));
...
void gtimer_stop (gtimer_t *obj)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"C:\\Users\\Administrator\\Desktop\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 202));
